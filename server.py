...
def getCropsverbose(subID):
    try:
        ...
        JOIN tbl_media AS m ON c.fld_m_MediumID_fk = m.fld_m_MediumID_pk
        JOIN tbl_locations AS l ON  c.fld_l_LocationID_fk = l.fld_l_LocationID_pk
        JOIN tbl_farms AS f ON   c.fld_f_FarmID_fk = f.fld_f_FarmID_pk
        JOIN tbl_croptypes as ct ON c.fld_ct_CropTypeID_fk = ct.fld_ct_CropTypeID_pk
